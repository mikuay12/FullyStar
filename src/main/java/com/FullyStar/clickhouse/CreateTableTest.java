//package com.FullyStar.clickhouse;
...
//    private static String address = "jdbc:clickhouse://192.168.16.112:8123";
...
////    }
////    public static void createTable(String tableSql) throws Exception{
////        tableSql = "create table product(\n" +
////                " product_name String,\n" +
////                " percentage Float64,\n" +
////                " average_price float64\n" +
////                ") engine =MergeTree\n" +
////                " primary key (product_name)\n" +
////                " order by (product_name,average_price);";
////        Connection connection = getConn();
////        Statement statement = connection.createStatement();
////        boolean execute = statement.execute(tableSql);
////        if(execute){
...
////    }
////    public static void createTable(String tableSql) throws Exception{
////        tableSql = "create table pay(\n" +
////                " payway String,\n" +
////                " percentage Float64\n" +
////                ")engine =MergeTree\n" +
////                " PRIMARY KEY (payway)\n" +
////                " order by (payway,percentage);";
////        Connection connection = getConn();
////        Statement statement = connection.createStatement();
////        boolean execute = statement.execute(tableSql);
////        if(execute){
...
////    }
//    public static void createTable(String tableSql) throws Exception{
//        tableSql = "create table preference(\n" +
//                " age String,\n" +
//                " prefer_product Float64\n" +
//                ")engine =MergeTree\n" +
//                " PRIMARY KEY (age)\n" +
//                " order by (age,prefer_product);";
//        Connection connection = getConn();
//        Statement statement = connection.createStatement();
//        boolean execute = statement.execute(tableSql);
//        if(execute){
...
//        Connection connection = getConn();
//        PreparedStatement pstmt = connection.prepareStatement("insert into product values('camera', '0.5', '2500.00')");
//        pstmt.execute();
