...
<script type="text/javascript">
    ...
    function Finish(id){
        ...
        var user_ID = divs[0].innerHTML;
        var user_name = divs[1].innerHTML;
        var user_age = divs[2].innerHTML;
        var user_sex = divs[3].innerHTML;
        var user_phone = divs[4].innerHTML;
        var user_birth = divs[5].innerHTML;
